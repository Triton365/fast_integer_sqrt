...
void find_best_rational_estimate_rev(int64_t test_range, int64_t startx, bool is_div, int64_t *outendx, int64_t *outa, int64_t *outb, int64_t *outcmin, int64_t *outcmax) {
